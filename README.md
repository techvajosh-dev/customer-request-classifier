...
2. Create credentials for Gmail, Airtable, Slack, and your LLM provider, then reconnect each node — credential IDs are stripped from these exports
3. Create three Airtable tables: Customer Requests, Agent Directory, Workflow Errors
...
5. Adjust the categories in the agent's system prompt to match your own taxonomy
6. Set the workflow's error workflow to point at the error trigger
...
Built by [Joshua Clyde Manuel](https://joshuaclydemanuel.dev) — AI automation and workflow engineering.
****
